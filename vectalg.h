...
// JeĹźeli odkomentujemy poniĹźszÄ liniÄ to indeksy (asercje) nie bÄdÄ sprawdzane
// #define  NDEBUG
...
/**
 * Wektor wymiaru n.
 * DomyĹlnie nie jest wypeĹniany zerami.
 */
class Vector {
private:
    size_t n;
...
/**
 * Macierz n x n.
 * DomyĹlnie nie jest wypeĹniana zerami.
 */
class Matrix {
private:
    size_t n;
